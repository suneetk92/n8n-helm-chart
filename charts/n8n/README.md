...
![Version: 4.3.2](https://img.shields.io/badge/Version-4.3.2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2.41.3](https://img.shields.io/badge/AppVersion-2.41.3-informational?style=flat-square)
...
| sandboxService.image.version | string | `"1.5.0"` | Overrides the pinned service version used as the default image tag. The API, runner and sandbox images are released together and must match. |
