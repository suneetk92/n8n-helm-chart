...
![Version: 4.2.2](https://img.shields.io/badge/Version-4.2.2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2.40.5](https://img.shields.io/badge/AppVersion-2.40.5-informational?style=flat-square)
...
```console
helm install [RELEASE_NAME] oci://ghcr.io/suneetk92/n8n --version 4.2.2
```
...
> **Tip**: Inspect the defaults before installing with `helm show values oci://ghcr.io/suneetk92/n8n --version 4.2.2`. Available versions are listed on the [package page](https://github.com/suneetk92?tab=packages&repo_name=n8n-helm-chart).
...
```console
helm upgrade [RELEASE_NAME] oci://ghcr.io/suneetk92/n8n --version 4.2.2
```
