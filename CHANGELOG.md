...
- n8n `2.41.1` -> `2.41.2` (`appVersion`, the tag for both `n8nio/n8n` and `n8nio/runners`).

## 4.3.1

### Changed

- n8n `2.41.0` -> `2.41.1` (`appVersion`, the tag for both `n8nio/n8n` and `n8nio/runners`).

## 4.3.0

### Changed

- n8n `2.40.5` -> `2.41.0` (`appVersion`, the tag for both `n8nio/n8n` and `n8nio/runners`).

## 4.2.2

### Changed

- n8n `2.40.4` -> `2.40.5` (`appVersion`, the tag for both `n8nio/n8n` and `n8nio/runners`).
...
- Sandbox service `1.3.4` -> `1.4.0` (all three `n8n-sandbox-service-*` images).
